...
public class DetalleSolicitudController implements Serializable {
    ...
    @EJB
    private com.upc.indra.dao.DetalleSolicitudFacade ejbFacade;
    private List<DetalleSolicitud> items = null;
    private DetalleSolicitud selected;
    ...
    public void setSelected(DetalleSolicitud selected) {
    ...
    public DetalleSolicitud prepareCreate() {
        selected = new DetalleSolicitud();
        initializeEmbeddableKey();
        return selected;
    }

    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/com/upc/indra/messages").getString("DetalleSolicitudCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/com/upc/indra/messages").getString("DetalleSolicitudUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/com/upc/indra/messages").getString("DetalleSolicitudDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<DetalleSolicitud> getItems() {
        if (items == null) {
    ...
    public List<DetalleSolicitud> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<DetalleSolicitud> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class DetalleSolicitudControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof DetalleSolicitud) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), DetalleSolicitud.class.getName()});
                return null;
            }
        }
