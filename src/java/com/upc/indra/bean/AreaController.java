...
import com.upc.indra.dao.AreaFacade;
...
public class AreaController implements Serializable {
    ...
    @EJB
    private com.upc.indra.dao.AreaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/com/upc/indra/messages").getString("AreaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/com/upc/indra/messages").getString("AreaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/com/upc/indra/messages").getString("AreaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
