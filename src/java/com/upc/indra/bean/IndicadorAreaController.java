...
public class IndicadorAreaController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, "Se creo correctamente");
    ...
    public void update() {
        persist(PersistAction.UPDATE, "Se edito correctamente");
    }

    public void destroy() {
        persist(PersistAction.DELETE, "Se elimino correctamente");
        if (!JsfUtil.isValidationFailed()) {
