...
public class MarcaMaterialController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/com/upc/indra/messages").getString("MarcaMaterialCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/com/upc/indra/messages").getString("MarcaMaterialUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/com/upc/indra/messages").getString("MarcaMaterialDeleted"));
        if (!JsfUtil.isValidationFailed()) {
